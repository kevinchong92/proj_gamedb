...
async function fetchGames() {
    ...
    const response = await fetch(`https://api.rawg.io/api/games?key=9a1696f1e3c64d7d97ee72af929867dc&dates=${targetDate},${today}&ordering=-released&page_size=12&platforms=1,7,186,187`);
